                        ...
                        <div class="row">
                            <div class="col-md-12 objeto-postar">
                                <div>
                                    ...
                                    <button   class="btn btn-shyme-default btn-post" data-toggle="modal" data-target="#myModal1">Publicar</button>
                                </div>
                                <!-- </alteracao> -->
                            </div>
                        </div>
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <h4 class="modal-title" id="myModalLabel">Valor do Comunicado</h4>
                                    </div>
